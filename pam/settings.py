...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'pam', 'static'),
)
SITE_ID = 1
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'pam', 'templates'),],
        'OPTIONS': {
            'context_processors': [
...
INSTALLED_APPS = (
	...
	# customised plugin for social media shares
	'social_share',
	# even better plugin for social media shares
